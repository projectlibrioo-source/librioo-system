...
export default function RobotLayout({ children }) {
  return (
    <div className="bg-[linear-gradient(180deg,#2c3e50_0%,#4a6278_100%)] w-full h-screen flex flex-col overflow-hidden">

      {/* Header */}
      <header className="relative w-full pt-4 h-[120px] flex-shrink-0">
      ...
      {/* Page content */}
      <section className="flex-1 min-h-0 overflow-hidden" style={{ marginTop: '14px', marginBottom: '30px' }}>
        {children}
      </section>
