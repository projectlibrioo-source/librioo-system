...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 2: Get role from Firestore users collection
      ...
      if (role === "admin") {
        ...
        await logActivity("member", "user", `Robot operator logged in: ${adminId.trim()}`);
        navigate("/robot/login", { replace: true });
  ...
  return (
    <div className="min-h-screen bg-[#f6f7fb] flex">
      ...
      <div className="hidden lg:flex w-[320px] bg-[#eef4fb] border-r border-[#dbe5f0] flex-col justify-between p-10">
        <div>
          <img src={logo} alt="Librioo Logo" className="h-20 w-auto" />
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-[#dbe5f0] bg-white px-5 py-4">
            ...
            <p className="mt-1 text-sm text-[#6b7280]">Manage and organize library collections.</p>
          </div>
          <div className="rounded-2xl border border-[#dbe5f0] bg-white px-5 py-4">
            <p className="text-sm font-semibold text-[#111827]">Users</p>
            <p className="mt-1 text-sm text-[#6b7280]">Maintain member and guest information.</p>
          </div>
          <div className="rounded-2xl border border-[#dbe5f0] bg-white px-5 py-4">
            <p className="text-sm font-semibold text-[#111827]">Robot Status</p>
            <p className="mt-1 text-sm text-[#6b7280]">Monitor and manage guidance features.</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-[500px]">
          <div className="mb-8">
            ...
            <p className="mt-2 text-[15px] text-[#6b7280]">
              Sign in to continue to the Librioo system.
            </p>
          </div>
          ...
          <div className="rounded-[24px] border border-[#e5e7eb] bg-white shadow-[0_10px_30px_rgba(17,24,39,0.06)]">
            <div className="border-b border-[#eef2f7] px-8 py-5">
              <div className="flex items-center justify-between">
                <h3 className="text-[28px] font-bold text-[#111827]">Sign In</h3>
            ...
            <form onSubmit={handleSubmit} className="px-8 py-8">
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <a href="/forgot-password" className="text-sm font-semibold text-[#2563eb] hover:text-[#1d4ed8]">
                    Forgot password?
                  </a>
                </div>
